...
android {
    namespace = "com.gios.lightnoise"
    compileSdk = 35
    buildToolsVersion = "35.0.0"

    defaultConfig {
        applicationId = "com.gios.lightnoise"
        minSdk = 29
        targetSdk = 35
        ...
        // The LPIII is arm64 only; shipping four ABIs bloats the APK for nothing.
        ndk { abiFilters += "arm64-v8a" }
    }

    signingConfigs {
        getByName("debug") {
            storeFile = file("../keystore/lightnoise.jks")
            storePassword = "lightnoise"
            keyAlias = "lightnoise"
            keyPassword = "lightnoise"
        }
    }
...
dependencies {
    ...
    // same code under com.gios.lightnoise.report until this version.
    ...
    // material-icons-extended is deliberately absent: on LightTip it alone was ~30 MB.
